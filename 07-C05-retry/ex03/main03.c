...
/*   Updated: 2019/10/21 08:55:32 by esuguimo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	assert(25 == ft_recursive_power(5,2));
	assert(16 == ft_recursive_power(4,2));
	assert(0 == ft_recursive_power(0,3));

	int	x;
	x = ft_recursive_power(5,2);
	printf("5 ao quadrado é 25 = %d\n", x);
	x = ft_recursive_power(2,3);
	printf("2 ao cubo é 8 = %d\n", x);
	x = ft_recursive_power(4,5);
	printf("4 a quinta é 1024 = %d\n", x);
	x = ft_recursive_power(0,3);
	printf("0 ao cubo é 0 = %d\n", x);
	x = ft_recursive_power(3,1);
	printf("3 a 1 é 3 = %d\n", x);
	x = ft_recursive_power(2,0);
	printf("2 a 0 é 1 = %d\n", x);
